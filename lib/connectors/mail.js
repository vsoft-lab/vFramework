...
var mailer = require('nodemailer'),
    ...
    debug = require('debug')('vframe:connector:mail'), 
...
/**
 * Gửi một email với tham số `options`.
 *
 * Ví dụ:
 *
 * {
...
/**
 * Gửi một Email instance sử dụng `modelInstance.send()`.
 */
