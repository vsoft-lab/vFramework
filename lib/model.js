...
var registry = require('./registry'),
    ...
    // RemoteObjects = require('vremoting'),
    // SharedClass = require('vremoting').SharedClass,
    RemoteObjects = require('strong-remoting'),
    SharedClass = require('strong-remoting').SharedClass,
 ...
 * var properties = {...};
 * var options = {...};
 * var MyModel = vframe.Model.extend('MyModel', properties, options);
 * ```
 *
 * **Options**
 *
...
Model.ValidationError = require('vsoft-datasource-juggler').ValidationError;
