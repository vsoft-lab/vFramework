 ...
 * Module Dependencies.
 */
var PersistedModel = require('../../lib/vframe').PersistedModel
, vframe = require('../../lib/vframe')
, crypto = require('crypto')
, CJSON = {stringify: require('canonical-json')}
, async = require('async')
, assert = require('assert')
, debug = require('debug')('vframe:change');
/**
 * Change list entry.
 *
...
module.exports = function(Change) {
    ...
    Change.findOrCreateChange = function(modelName, modelId, callback) {
        assert(vframe.findModel(modelName), modelName + ' does not exist');
    ...
    Change.getCheckpointModel = function() {
        ...
        this.checkpoint = checkpointModel = vframe.Checkpoint.extend('checkpoint');
