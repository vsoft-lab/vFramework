...
var debug = require('debug')('vframe:security:role');
var assert = require('assert');
var async = require('async');
var AccessContext = require('../../lib/access-context').AccessContext;
var RoleMapping = vframe.RoleMapping;
...
module.exports = function(Role) {
    // Workaround for https://github.com/strongloop/vframe/issues/292
    ...
    Role.once('dataSourceAttached', function() {
        var roleMappingModel = this.RoleMapping || vframe.getModelByType(RoleMapping);
    ...
    function isUserClass(modelClass) {
        return modelClass === vframe.User ||
            modelClass.prototype instanceof vframe.User;
    };
